...
workspace package (`@workspace/human-systems`): other artifacts depend
...
`@workspace/human-systems/components/...`. Never use a `@/` alias inside
...
for `@workspace/human-systems` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/human-systems` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/human-systems/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/human-systems/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/human-systems/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/human-systems/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/human-systems/docs/migrating-expo.md`
