# Migrating web UI to Human Systems

Read `artifacts/human-systems/docs/AGENTS.md` and
`artifacts/human-systems/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/human-systems/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/human-systems/lib/utils`
- `@/hooks/use-toast` → `@workspace/human-systems/hooks/use-toast`
