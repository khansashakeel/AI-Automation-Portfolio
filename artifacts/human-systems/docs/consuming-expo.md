# Consuming Human Systems in Expo apps

Read `artifacts/human-systems/docs/AGENTS.md` first. React Native does
...
`artifacts/human-systems/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/human-systems/tokens";
...
```tsx
import { nativeTheme } from "@workspace/human-systems/lib/native-theme";
import { useColors } from "@workspace/human-systems/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/human-systems/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/human-systems/components/native/badge";
import { Button } from "@workspace/human-systems/components/native/button";
import { Card } from "@workspace/human-systems/components/native/card";
```
...
Import and render
`@workspace/human-systems/components/native/button`, then run Expo
