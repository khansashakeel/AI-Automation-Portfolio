# Migrating Expo UI to Human Systems

Read `artifacts/human-systems/docs/AGENTS.md` and
`artifacts/human-systems/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/human-systems/lib/native-theme` and
  `@workspace/human-systems/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/human-systems/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/human-systems` and retains only
